...
`;
class GalaxyShader extends THREE.ShaderMaterial {
    constructor(params = {}) {
        ...
        super({
            uniforms: {
                u_resolution: {
                    value: (_a = params.resolution) !== null && _a !== void 0 ? _a : new THREE.Vector2(1200, 1200),
                },
                u_color: { value: (_b = params.color) !== null && _b !== void 0 ? _b : new THREE.Color(0xffffff) },
                u_pointSize: { value: (_c = params.pointSize) !== null && _c !== void 0 ? _c : 2.0 },
                u_totalPoints: { value: (_d = params.totalStars) !== null && _d !== void 0 ? _d : 10000 },
                u_time: { value: (_e = params.time) !== null && _e !== void 0 ? _e : 0 },
                u_blackHoleRadius: { value: (_f = params.blackHoleRadius) !== null && _f !== void 0 ? _f : 0.2 },
                u_blackHolePosition: {
                    value: (_g = params.blackHolePosition) !== null && _g !== void 0 ? _g : new THREE.Vector3(0, 0, 0),
                },
                u_spiralCount: { value: (_h = params.spiralCount) !== null && _h !== void 0 ? _h : 3 },
                u_turnsPerSpiral: { value: (_j = params.turnsPerSpiral) !== null && _j !== void 0 ? _j : 1 },
                u_fadeNear: { value: (_k = params.fadeNear) !== null && _k !== void 0 ? _k : 1.0 },
                u_fadeFar: { value: (_l = params.fadeFar) !== null && _l !== void 0 ? _l : 5.0 },
                // New color uniforms
                u_colorMode: { value: (_m = params.colorMode) !== null && _m !== void 0 ? _m : 0 },
                u_colorPalette: { value: paddedPalette },
                u_paletteSize: { value: paletteSize },
                u_colorIntensity: { value: (_o = params.colorIntensity) !== null && _o !== void 0 ? _o : 1.0 },
            },
...
exports.GalaxyShader = GalaxyShader;
